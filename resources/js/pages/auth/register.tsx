        ...
        <div className="bg-muted/40 min-h-screen py-10 px-4 sm:px-6 flex flex-col justify-center items-center">
            ...
            <div className="w-full max-w-xl flex flex-col gap-6">
                ...
                <Card className="rounded-2xl border-border/70 shadow-xl shadow-teal-950/5 overflow-hidden p-0 gap-0">
                    ...
                    <div className="relative bg-gradient-to-r from-teal-600 via-teal-700 to-emerald-800 text-white p-6 sm:p-7 overflow-hidden">
                        ...
                        <div className="relative z-10 space-y-1.5">
                            <Badge className="bg-teal-500/25 hover:bg-teal-500/35 text-teal-100 border-teal-400/30 text-xs px-2.5 py-0.5 font-medium inline-flex items-center gap-1.5 backdrop-blur-sm">
                                ...
                                Pendaftaran Akun Inovator
                            </Badge>
                            <h1 className="text-xl sm:text-2xl font-bold tracking-tight">
                                Registrasi Akun Baru
                            </h1>
                            <p className="text-teal-100/90 text-sm leading-relaxed">
                                Daftarkan nama dan email Anda. Kelengkapan profil instansi/komunitas dapat dilengkapi setelah masuk ke aplikasi.
                            </p>
                        </div>
                    </div>
                            ...
                            {({ processing, errors }) => (
                                <>
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid gap-2">
                                            ...
                                            <p className="text-xs text-muted-foreground">
                                                Tautan verifikasi akun akan dikirimkan ke email ini setelah pendaftaran.
                                            </p>
                                            ...
                                            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                                                ...
                                                <div className="flex-1">
                                                    <Input
                                                        ...
                                                        required
                                                        tabIndex={5}
                                                        placeholder="Hasil perhitungan angka..."
                                    ...
                                    <div className="pt-2 text-center text-sm text-muted-foreground border-t border-border/60">
                                        Sudah memiliki akun?{' '}
                                        <TextLink href={login()} tabIndex={7} className="font-semibold text-teal-700 dark:text-teal-400 hover:underline">
                                            Masuk di sini
                                        </TextLink>
                                    </div>
                                </>
