...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Master Perangkat Daerah', href: '/superadmin/opd' },
];

export default function SuperadminOpdIndex({ opdList, filters, metrics }: Props) {
    const tableData = opdList?.data || [];
    const pagination = opdList;
    ...
    const handleSearch = (e: React.FormEvent) => {
        e.preventDefault();
        router.get('/superadmin/opd', { search: search || undefined }, { preserveState: true, replace: true });
    };

    const handleResetSearch = () => {
        setSearch('');
        router.get('/superadmin/opd', {}, { preserveState: true, replace: true });
    };
    ...
    const handleCreateSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        createForm.post('/superadmin/opd', {
            onSuccess: () => {
    ...
    const handleEditSubmit = (e: React.FormEvent) => {
        ...
        editForm.put(`/superadmin/opd/${editingOpd.id}`, {
            onSuccess: () => {
                setEditingOpd(null);
                editForm.reset();
            },
    ...
    const handleDelete = () => {
        ...
        router.delete(`/superadmin/opd/${deletingOpd.id}`, {
            onSuccess: () => {
                setDeletingOpd(null);
            },
        });
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="flex flex-col gap-0.5">
                    <Link
                        href={`/superadmin/inovasi-daerah?opd_id=${row.id}`}
        ...
        },
        {
            ...
            cell: (row) => (
                <div className="flex items-center justify-end gap-1.5">
                    ...
                    >
                        <Link href={`/superadmin/inovasi-daerah?opd_id=${row.id}`}>
    ...
    return (
        <div className="space-y-6 max-w-7xl mx-auto p-4 md:p-6 w-full">
            <Head title="Master Perangkat Daerah — BAPPERIDA" />
