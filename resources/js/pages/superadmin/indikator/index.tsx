...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Master Indikator', href: '/superadmin/indikator' },
];

export default function SuperadminIndikatorIndex({ spdList, sidList }: Props) {
    const [activeTab, setActiveTab] = useState<'sid' | 'spd'>('sid');
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const url = activeTab === 'spd'
            ? (editingItem ? `/superadmin/indikator/spd/${editingItem.id}` : '/superadmin/indikator/spd')
            : (editingItem ? `/superadmin/indikator/sid/${editingItem.id}` : '/superadmin/indikator/sid');
    ...
    return (
        <>
            <Head title="Master Indikator Penilaian — BAPPERIDA" />
...
SuperadminIndikatorIndex.layout = {
    breadcrumbs,
};
